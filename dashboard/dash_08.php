...
<ul class="nav nav-tabs nav-justified">
  ...
  <li role="presentation" class="active"><a href="<?php echo BASEURL; ?>dashboard/dash_08.php">Agosto</a></li>
  ...
  <li role="presentation"><a href="<?php echo BASEURL; ?>dashboard/dash_12.php">Dezembro</a></li>
	...
	<div>
		...
		<hr />
				...
				<tbody>
					<?php
                        $cont_devolucao = contagemDevolucaoTotalMes('08');
                        $cont_teste = contagemTesteTotalMes('08');
                    ?>
					<tr>
		...
		<hr />
			...
			<tbody>
				...
				<?php 
                    $cont_descricao_devolucao = contagemMensalPorDescricao('devolucao', $i['nome_equip'], 'data', '08');
                    $cont_descricao_teste = contagemMensalPorDescricao('teste', $i['nome_equip'], 'created', '08');
                ?>
				<tr>
					<td class ="text-center">
					<?php
		...
		<hr />
			...
			<tbody>
				...
				<?php 
                    $cont_itens_devolucao = contagemMensalPorModelo('devolucao', 'equipamento', 'equipamento_id', 'modelo_id', $modelo['id'], 'id', 'data', '08');
                    $cont_itens_teste = contagemMensalPorModelo('teste', 'equipamento', 'equipamento_id', 'modelo_id', $modelo['id'], 'id', 'created', '08');
                ?>
				<tr>
					<td class ="text-center">
						<?php
