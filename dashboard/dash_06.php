...
<ul class="nav nav-tabs nav-justified">
  ...
  <li role="presentation" class="active"><a href="<?php echo BASEURL; ?>dashboard/dash_06.php">Junho</a></li>
  ...
  <li role="presentation"><a href="<?php echo BASEURL; ?>dashboard/dash_12.php">Dezembro</a></li>
	...
	<div>
		...
		<hr />
				...
				<tbody>
					<?php
                        $cont_devolucao = contagemDevolucaoTotalMes('06');
                        $cont_teste = contagemTesteTotalMes('06');
                    ?>
					<tr>
		...
		<hr />
			...
			<tbody>
				...
				<?php 
                    $cont_descricao_devolucao = contagemMensalPorDescricao('devolucao', $i['nome_equip'], 'data', '06');
                    $cont_descricao_teste = contagemMensalPorDescricao('teste', $i['nome_equip'], 'created', '06');
                ?>
				<tr>
					<td class ="text-center">
					<?php
		...
		<hr />
			...
			<tbody>
				...
				<?php 
                    $cont_itens_devolucao = contagemMensalPorModelo('devolucao', 'equipamento', 'equipamento_id', 'modelo_id', $modelo['id'], 'id', 'data', '06');
                    $cont_itens_teste = contagemMensalPorModelo('teste', 'equipamento', 'equipamento_id', 'modelo_id', $modelo['id'], 'id', 'created', '06');
                ?>
				<tr>
					<td class ="text-center">
						<?php
